...
func init() {
	//执行main之前 先执行init方法
	dataSourceName := fmt.Sprintf("root:123456@tcp(localhost:3306)/goblog?"+
		"charset=utf8&loc=%s&parseTime=true",
...
func (d *MsDB) QueryOne(model any, sql string, args ...any) error {
